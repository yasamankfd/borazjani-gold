...
<div id="app">
    <div class="container mt-5 mb-5">
        <button @if($product->buy_status == 0) disabled @endif id="change_to_buy" onclick="change_operation('buy',{{ $product->buy_price }},{{ $product->sell_price }})" style="width: 400px" class="btn btn-success">Buy</button>
        <button @if($product->sell_status == 0) disabled @endif id="change_to_sell" onclick="change_operation('sell',{{ $product->buy_price }},{{ $product->sell_price }})" style="width: 400px" class="btn btn-danger">Sell</button>
        <div>
