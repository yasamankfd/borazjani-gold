...
{{--                                              <span id="countdownValue_{{$order->id}}" class="bg-colorsecondry2 px-4 py-2 w-full text-white rounded-full flex max-w-fit font-extrabold text-base">--}}
{{--                                                150 ثانیه--}}
{{--                                            </span>--}}
                                          </td>
                                          <td class="oneLine text-lengh w-36 xl:w-[10%] text-center border-l font-light tracking-tight text-sm flex gap-1 justify-center">
...
@section("scripts")
    ...
    <script>
        ...
        //
        //     let _url = 'admin-save-order/' + order_id;
        //
        //     $.ajaxSetup({
        //         headers: {
